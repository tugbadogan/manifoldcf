/* $Id: KafkaParam.java 1299512 2012-03-12 00:58:38Z piergiorgio $ */
...
import org.apache.manifoldcf.agents.output.kafka.KafkaParam.ParameterEnum;

/** 
 * Parameters data for the kafka output connector.
*/
public class KafkaParam extends HashMap<ParameterEnum, String>
{
	...
	protected KafkaParam(ParameterEnum[] params)
	{
		super(params.length);
	}
